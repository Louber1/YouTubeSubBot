...
def Ytpals():
    ...
    def likeandsubscribe():
        ...
        WebDriverWait(driver, 5).until(
            ec.element_to_be_clickable((By.XPATH,
                                        '/html/body/div[1]/section/div/div/div/div/div/div[3]/div[2]/div/div[2]/div[1]/a'))).click()
        time.sleep(10)
    ...
    try:
        ...
        while True:
            try:
                ...
                driver.quit()
                print("Alle Kanäle Abonniert und geliked, bis zu, Ytpals Abgeschlossen")
                break

    ...
    def likeandsubscribe():
        ...
        try:
            ...
            skip = driver.find_element_by_xpath(
                "/html/body/div[1]/section/div/div/div/div/div/div[2]/div[2]/div[2]/div/div[2]/div[5]/a")
            skip.click()
        finally:
            time.sleep(60)
    ...
    try:
        ...
        while True:
            try:
                ...
                driver.quit()
                print("Alle Kanäle Abonniert und geliked, Subpals abgeschlossen")
                break
